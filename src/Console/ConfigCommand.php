...
namespace Sumantablog\Admin\Console;
...
class ConfigCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'superadmin:config {path?}';
    ...
    public function handle()
    {
        ...
        $this->line('');
        $this->comment('Please open `vendor/sumantablog/laravel-superadmin/config/admin.php` to check the difference');
    }
