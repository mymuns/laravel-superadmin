...
namespace Sumantablog\Admin\Facades;
 ...
 * Class Admin.
 *
 * @method static \Sumantablog\Admin\Grid grid($model, \Closure $callable)
 * @method static \Sumantablog\Admin\Form form($model, \Closure $callable)
 * @method static \Sumantablog\Admin\Show show($model, $callable = null)
 * @method static \Sumantablog\Admin\Tree tree($model, \Closure $callable = null)
 * @method static \Sumantablog\Admin\Layout\Content content(\Closure $callable = null)
 ...
 *
 * @see \Sumantablog\Admin\Admin
 */
class Admin extends Facade
{
    protected static function getFacadeAccessor()
    {
        return \Sumantablog\Admin\Admin::class;
    }
}
