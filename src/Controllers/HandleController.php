...
namespace Sumantablog\Admin\Controllers;

use Sumantablog\Admin\Actions\Action;
use Sumantablog\Admin\Actions\GridAction;
use Sumantablog\Admin\Actions\Response;
use Sumantablog\Admin\Actions\RowAction;
use Sumantablog\Admin\Widgets\Form;
use Sumantablog\Admin\Widgets\Selectable\Selectable;
use Exception;
...
class HandleController extends Controller
{
    ...
    public function handleSelectable(Request $request)
    {
        ...
        if (class_exists($class)) {
            /** @var \Sumantablog\Admin\Grid\Selectable $selectable */
