...
use Sumantablog\Admin\Controllers\AuthController;
use Sumantablog\Admin\Layout\Content;
use Sumantablog\Admin\Traits\HasAssets;
...
class Admin
{
     ...
     * @param Closure $callable
     *
     * @return \Sumantablog\Admin\Layout\Content
     *
     * @deprecated since v1.6.1
     */
     ...
     * Get navbar object.
     *
     * @return \Sumantablog\Admin\Widgets\Navbar
     */
    ...
    public function routes()
    {
        ...
        app('router')->group($attributes, function ($router) {
            ...
            $router->namespace('\Sumantablog\Admin\Controllers')->group(function ($router) {
