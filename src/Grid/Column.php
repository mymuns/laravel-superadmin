...
namespace Sumantablog\Admin\Grid;

use Carbon\Carbon;
use Closure;
use Sumantablog\Admin\Actions\RowAction;
use Sumantablog\Admin\Grid;
use Sumantablog\Admin\Grid\Displayers\AbstractDisplayer;
...
class Column
{
    ...
    public function action($action)
    {
        if (!is_subclass_of($action, RowAction::class)) {
            throw new \InvalidArgumentException("Action class [$action] must be sub-class of [Sumantablog\Admin\Actions\GridAction]");
        }
