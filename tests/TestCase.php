...
class TestCase extends BaseTestCase
{
    ...
    public function createApplication()
    {
        ...
        $app->booting(function () {
            ...
            $loader->alias('Admin', \Sumantablog\Admin\Facades\Admin::class);
        });

        $app->make('Illuminate\Contracts\Console\Kernel')->bootstrap();

        $app->register('Sumantablog\Admin\AdminServiceProvider');
    ...
    protected function setUp(): void
    {
        ...
        $this->artisan('vendor:publish', ['--provider' => 'Sumantablog\Admin\AdminServiceProvider']);
...
//        \Sumantablog\Admin\Admin::$css = [];
//        \Sumantablog\Admin\Admin::$js = [];
//        \Sumantablog\Admin\Admin::$script = [];
    }
